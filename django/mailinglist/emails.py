...
CONFIRM_SUBSCRIPTION_HTML = 'confirmation.html'
CONFIRM_SUBSCRIPTION_TXT = 'confirmation.txt'
...
def send_confirmation_email(subscriber):
    ...
    subject = 'Confirmation subscribtion to {}'.format(mailing_list.name)
    ...
    send_mail(subject=subject, message=text_body,from_email=settings.MAILING_LIST_FROM_EMAIL, recipient_list=(subscriber.email,), html_message=html_body)